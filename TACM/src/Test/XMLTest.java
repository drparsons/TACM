...
public class XMLTest {
		...
		//method for looping chargeables and printing description

		//looping downcasting, print code, if production loop chargeable array
		...
		public static void main(String[] args) {
			...
			ArrayCHGs.add(must20);
			ArrayCHGs.add(must21);
			...
			Task task2 = new Task("Production Floor", mustang, "Floor");
			task1.setStartTime();
			try {
